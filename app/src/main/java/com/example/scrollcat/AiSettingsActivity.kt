...
class AiSettingsActivity : Activity() {
    ...
    private fun bindDownloadProgressUi(percent: Int, downloaded: Long, total: Long) {
        ...
        progressLabel.text = formatDownloadProgress(percent, downloaded, total)
    }
    ...
    private fun formatDownloadProgress(percent: Int, downloaded: Long, total: Long): String {
        ...
        return if (total > 0) {
            ...
            String.format(Locale.US, "%d%% — %.0f MB downloaded", percent, dlMb)
        }
    }
